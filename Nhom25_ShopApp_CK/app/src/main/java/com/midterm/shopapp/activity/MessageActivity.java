...
import com.midterm.shopapp.adapter.MessageAdapter;
import com.midterm.shopapp.model.Chat;
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!msg.equals("")){
                    ...
                    Toast.makeText(MessageActivity.this, "You can't send empty messsage", Toast.LENGTH_SHORT).show();;
                }
                text_send.setText("");
            }
        });
